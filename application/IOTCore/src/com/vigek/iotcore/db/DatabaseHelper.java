...
{
	private static final String TABLE_NAME = "sqlite-smarthome.db";
			...
			ConnectionSource connectionSource)
	{
		try
		{
			...
			TableUtils.createTable(connectionSource, HMessage.class);
			...
			ConnectionSource connectionSource, int oldVersion, int newVersion)
	{
		try
		{
			...
			TableUtils.dropTable(connectionSource, HMessage.class, true);
